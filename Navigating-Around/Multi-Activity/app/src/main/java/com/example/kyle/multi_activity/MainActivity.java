...
public class MainActivity extends Activity implements MainFragment.contactDetails {

    private final int CREATECODE = 102;
    private final int DETAILCODE = 101;
    public static ArrayList<DataHelper> mContactDetail = new ArrayList<DataHelper>();
